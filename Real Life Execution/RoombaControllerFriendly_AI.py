...
def on_message(client, userdata, msg):
    ...
    if (msg.topic == '/roomba2/state_enemy'):
        ...
        print("Damn it I lost, better luck next game I guess.. Reset incoming!")
        reset()
...
def step(state_friendly, state_enemy):
    ...
    if (done == True):
        ...
        client.publish('/roomba2/state_friendly', states, retain=False,qos=2)
        client.publish('/roomba2/turn_enemy', 1, retain=False,qos=2)
        client.publish('/roomba2/turn_friendly', 0, retain=False,qos=2)
...
if __name__ == '__main__':
    ...
    try:
        ...
        client.publish("/roomba2/state_enemy", "start", retain=False,qos=2)
